...
PROJECT_NAME="deno"
IMAGE_NAME="${IMAGE_NAME:-deno-medicao}"
MEDICAO_DIR="$HOME/experimentos/medicao/repositorios/deno"
RESULTS_DIR="${RESULTS_DIR:-$HOME/experimentos/medicao/resultados/deno/runs}"
LOGS_DIR="${LOGS_DIR:-$HOME/experimentos/medicao/resultados/deno/logs}"
...
if ! docker image inspect "$IMAGE_NAME" &>/dev/null; then
  ...
  echo "    ~/experimentos/repositorios/nao-ml/deno/" >&2
  exit 1
fi
